...
System.out.println("The sum of even numbers in the elements is "+Arraysss.sumOfOddNumbersIn(array));
...
System.out.println("The number of the even elements is "+Arraysss.squareNumbersIn(array));
}
}